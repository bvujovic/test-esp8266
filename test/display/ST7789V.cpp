...
//* lib_deps = adafruit/Adafruit ST7735 and ST7789 Library@^1.9.3
//* https://learn.adafruit.com/2-0-inch-320-x-240-color-ips-tft-display?view=all
...
void setup(void)
{
  ...
  tft.fillScreen(ST77XX_BLACK);
  testdrawtext("12:14", ST77XX_YELLOW);
  delay(2000);
